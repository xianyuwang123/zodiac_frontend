...
const ArrowLeftIcon: React.FC<IconProps> = ({ color, size = 32 }) => {
  return (
    <svg height={size} viewBox="0 0 32 32" width={size}>
      <g id="arrow-left" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g
          transform="translate(16.242641, 16.242641) rotate(135.000000) translate(-16.242641, -16.242641) translate(13.242641, 13.242641)"
          fill="#333333"
        >
